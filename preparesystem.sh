...
which apt  > /dev/null 2>&1 && {
	...
	sudo apt -y install wget build-essential zlib1g-dev liblua5.1-dev autoconf libtool libpcre3-dev libxml2-dev subversion libexpat1-dev libcurl4-openssl-dev libyajl-dev brotli python
}
